...
export class Query {
   ...
   */
  queryTwins(querySpecification: Models.QuerySpecification, options?: msRest.RequestOptionsBase): Promise<Models.QueryQueryTwinsResponse>;
  /**
   * @param querySpecification The query specification to execute.
   * @param callback The callback
   */
  queryTwins(querySpecification: Models.QuerySpecification, callback: msRest.ServiceCallback<Models.QueryResult>): void;
  /**
   * @param querySpecification The query specification to execute.
   * @param options The optional parameters
   * @param callback The callback
   */
  queryTwins(querySpecification: Models.QuerySpecification, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.QueryResult>): void;
  queryTwins(querySpecification: Models.QuerySpecification, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.QueryResult>, callback?: msRest.ServiceCallback<Models.QueryResult>): Promise<Models.QueryQueryTwinsResponse> {
...
const queryTwinsOperationSpec: msRest.OperationSpec = {
  httpMethod: "POST",
  path: "query",
  queryParameters: [
