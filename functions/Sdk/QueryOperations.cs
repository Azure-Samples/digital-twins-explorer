...
namespace AdtExplorer.Functions.Sdk
{
    ...
    /// </summary>
    internal partial class QueryOperations : IServiceOperations<AzureDigitalTwinsAPIClient>, IQueryOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal QueryOperations(AzureDigitalTwinsAPIClient client)
        {
            if (client == null)
            {
